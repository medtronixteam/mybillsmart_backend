                ...
                <div class="col-12 col-md-10">
                    <div class="card">
                        <div class="card-header">
                            <h2>{{$data?"Update":"Create"}} Combined Agreement</h2>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            @endif
                            <form action="{{ $data ? route('combined.update') :  route('combined.store') }}" method="POST">
                                @csrf
                                 <input type="text" name="both_id" value="{{$data?$data->id:"" }}" hidden>
                                <div class="row">
                                    <div class="col-md-6">
