            ...
            <div class="row">
                <div class="col-12 align-self-center">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Electricity Agreements
                            </h3>
                        </div>
                        <div> <a href="{{ route('agreements') }}" class="btn btn-info">Electricity</a>
                            <a href="{{ route('gas.list') }}" class="btn btn-success">Gas</a>
                            <a href="{{ route('combined.list') }}" class="btn btn-warning">Combined</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary" href="{{ route('electricity.create') }}" class="">Add
                                Electricity Agreement</a>
                        </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <li><a class="dropdown-item" href="{{ route('electricity.view', $item->id) }}">View</a>
                                                                </li>
                                                                <li> <a href="{{ route('electricity.edit', $item->id) }}"
